...
## For Debian 9 - 11 Only For First Time Installation (Update Repo) <br>
...
- via WGET
```
bash -c "$(wget -qO- https://raw.githubusercontent.com/toniakbar/XRAY-LITE/master/xray)"
```
- via CURL
```
bash -c "$(curl -fsSL https://raw.githubusercontent.com/toniakbar/XRAY-LITE/master/xray)"
```
