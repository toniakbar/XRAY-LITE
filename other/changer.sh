...
clear
echo -e "\e[33m ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo -e "\e[32m                  ❇ \e[34mDNS Setting\e[32m ❇ \e[34m"
echo -e "\e[33m ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
udns=$(cat /user/current)
echo -e ""
echo -e " ${GB}Current DNS${NC} : ${GB}$udns${WB}"
echo -e ""
echo -e " ${GB}[1]${NC} Google DNS${NC}"
echo -e " ${GB}[2]${NC} Cloudflare DNS${NC}"
echo -e " ${GB}[3]${NC} Cisco OpenDNS${NC}"
echo -e " ${GB}[4]${NC} Quad9 DNS${NC}"
echo -e " ${GB}[5]${NC} Level 3 DNS${NC}"
echo -e " ${GB}[6]${NC} Freenom World DNS${NC}"
echo -e " ${GB}[7]${NC} Neustar DNS${NC}"
echo -e " ${GB}[8]${NC} AdGuard DNS${NC}"
echo -e " ${GB}[9]${NC} Custom DNS${NC}"
echo -e ""
echo -e " ${GB}[10]${NC} ${YB}Back To Main Menu${NC}"
echo ""
